...
// Type: TradeMonitor.LmaxInstrumetns
...
{
  public class LmaxInstrumetns : Form
  {
    ...
    public LmaxInstrumetns()
    {
      this.InitializeComponent();
      this.lwInstruments.Rows.Clear();
      lock (SettingsProvider.Settings.LocalSetting.LmaxInstruments)
      {
        int num = 1;
        foreach (SettingsProvider.Settings.LmaxValues lmaxValues in SettingsProvider.Settings.LocalSetting.LmaxInstruments.Values)
        {
          ...
          row.Cells[nameof (InstrumentId)].Value = (object) lmaxValues.InstrumentId.ToString();
          row.Cells[nameof (InstrumentName)].Value = (object) lmaxValues.Name;
          row.Cells[nameof (Active)].Value = (object) lmaxValues.Enabled;
        }
      }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (LmaxInstrumetns));
      ...
      this.label4.Size = new Size(291, 39);
      this.label4.TabIndex = 84;
      this.label4.Text = "For add new instrument in list, enter Instrument ID and Name\r\nNext Click \"Send\". For Example: Instrument Id: 4001 \r\nInstrument Name: EURUSD";
      ...
      this.lName.Size = new Size(42, 16);
      ...
      this.label3.Text = "Lmax Instruments";
      ...
      this.Name = nameof (LmaxInstrumetns);
      this.Text = "Lmax Instruments";
