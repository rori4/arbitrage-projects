...
// Type: TradeMonitor.IQInstruments
...
{
  public class IQInstruments : Form
  {
    ...
    public IQInstruments()
    {
      this.InitializeComponent();
      this.lwInstruments.Rows.Clear();
      if (SettingsProvider.Settings.LocalSetting.rithmicSubscriptions == null)
        return;
      lock (SettingsProvider.Settings.LocalSetting.rithmicSubscriptions)
      {
        int num = 1;
        foreach (SettingsProvider.Settings.IQFeedInstruments iqInstrument in SettingsProvider.Settings.LocalSetting.IQInstruments)
        {
          ...
          row.Cells[nameof (InstrumentId)].Value = (object) iqInstrument.Id.ToString();
          row.Cells[nameof (InstrumentName)].Value = (object) iqInstrument.Symbol;
          row.Cells[nameof (Active)].Value = (object) iqInstrument.Enabled;
        }
      }
    ...
    private void button8_Click(object sender, EventArgs e)
    {
      ...
      if (!MainWindow.processes.ContainsKey("IQ"))
        return;
      MainWindow.stopProcess("IQ");
    ...
    {
      this.panel2.Focus();
      this.tbName.Text = this.tbInstrumentId.Text;
      Error1.showError(SettingsProvider.Settings.LocalSetting.addNewInstrument(this.tbInstrumentId.Text, this.tbIQName.Text, "", 6, ""));
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (IQInstruments));
      ...
      this.panel2.BackgroundImage = (Image) Resources.lm16551;
      ...
      this.scrollPanel.Location = new Point(303, 134);
      this.scrollPanel.Name = "scrollPanel";
      this.scrollPanel.Size = new Size(25, 399);
      ...
      this.bDown.Location = new Point(3, 375);
      ...
      this.lwInstruments.Location = new Point(10, 155);
      ...
      this.lwInstruments.Size = new Size(295, 372);
      ...
      this.label4.Location = new Point(11, 634);
      this.label4.Name = "label4";
      this.label4.Size = new Size(264, 39);
      this.label4.TabIndex = 83;
      this.label4.Text = "For add new instrument in list, enter Instrument ID and \r\nName. Next Click \"Send\". For Example: Instrument Id: \r\nEURUSD.FXCM, Name: EURUSD";
      ...
      this.Exchange.BackColor = Color.Transparent;
      this.Exchange.Font = new Font("Arial", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 204);
      this.Exchange.ForeColor = Color.White;
      this.Exchange.Location = new Point(11, 611);
      this.Exchange.Name = "Exchange";
      this.Exchange.Size = new Size(42, 16);
      this.Exchange.TabIndex = 67;
      this.Exchange.Text = "Name";
      ...
      this.tbIQName.BackColor = Color.FromArgb(0, 22, 54);
      this.tbIQName.BorderStyle = BorderStyle.None;
      this.tbIQName.ForeColor = Color.White;
      this.tbIQName.Location = new Point(104, 614);
      this.tbIQName.Name = "tbIQName";
      this.tbIQName.Size = new Size(110, 13);
      this.tbIQName.TabIndex = 66;
      this.tbIQName.Text = "EURUSD";
      ...
      this.lName.Font = new Font("Arial", 12f);
      this.lName.ForeColor = Color.White;
      this.lName.Location = new Point(12, 597);
      this.lName.Name = "lName";
      this.lName.Size = new Size(0, 18);
      ...
      this.label3.Text = "IQ Feed Instruments";
      ...
      this.tbName.BackColor = Color.FromArgb(0, 28, 56);
      this.tbName.BorderStyle = BorderStyle.None;
      this.tbName.ForeColor = Color.White;
      this.tbName.Location = new Point(502, 600);
      this.tbName.Name = "tbName";
      this.tbName.Size = new Size(121, 13);
      ...
      this.Name = nameof (IQInstruments);
      this.Text = "IQ Feed Instruments";
