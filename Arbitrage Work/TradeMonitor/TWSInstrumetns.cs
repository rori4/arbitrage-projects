...
// Type: TradeMonitor.TWSInstrumetns
...
{
  public class TWSInstrumetns : Form
  {
    ...
    private TextBox tbSecType;
    private Label lSecType;

    public TWSInstrumetns()
    {
      this.InitializeComponent();
      this.lwInstruments.Rows.Clear();
      lock (SettingsProvider.Settings.LocalSetting.TWSInstruments)
      {
        int num = 1;
        foreach (SettingsProvider.Settings.TWSSubscription twsInstrument in SettingsProvider.Settings.LocalSetting.TWSInstruments)
        {
          ...
          row.Cells[nameof (InstrumentId)].Value = (object) twsInstrument.InstumentId;
          row.Cells[nameof (InstrumentName)].Value = (object) (twsInstrument.Symbol + "%" + twsInstrument.Currency);
          row.Cells[nameof (Active)].Value = (object) twsInstrument.Enabled;
        }
      }
      if (SettingsProvider.Settings.LocalSetting.TWSInstruments.Count > 0)
      {
    ...
    private void button8_Click(object sender, EventArgs e)
    {
      ...
      if (!MainWindow.processes.ContainsKey("TWS"))
        return;
      MainWindow.stopProcess("TWS");
    ...
    private void tbInstrumentId_KeyDown(object sender, KeyEventArgs e)
    {
    }

    private void tbInstrumentId_KeyPress(object sender, KeyPressEventArgs e)
    {
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (TWSInstrumetns));
      ...
      this.tbSecType = new TextBox();
      this.lSecType = new Label();
      this.lExchange = new Label();
      ...
      this.lwInstruments.Size = new Size(291, 372);
      ...
      this.InstrumentName.DefaultCellStyle = gridViewCellStyle;
      ...
      this.panel2.BackgroundImage = (Image) Resources.lm16552;
      this.panel2.BackgroundImageLayout = ImageLayout.Center;
      this.panel2.Controls.Add((Control) this.tbSecType);
      this.panel2.Controls.Add((Control) this.lSecType);
      this.panel2.Controls.Add((Control) this.lExchange);
      this.panel2.Controls.Add((Control) this.tbExchange);
      ...
      this.panel2.Controls.Add((Control) this.lName);
      ...
      this.tbSecType.BackColor = Color.FromArgb(0, 22, 54);
      this.tbSecType.BorderStyle = BorderStyle.None;
      this.tbSecType.ForeColor = Color.White;
      this.tbSecType.Location = new Point(106, 655);
      this.tbSecType.Name = "tbSecType";
      this.tbSecType.Size = new Size(110, 13);
      this.tbSecType.TabIndex = 96;
      this.tbSecType.Text = "CASH";
      this.lSecType.AutoSize = true;
      this.lSecType.BackColor = Color.Transparent;
      this.lSecType.Font = new Font("Arial", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 204);
      this.lSecType.ForeColor = Color.White;
      this.lSecType.Location = new Point(12, 655);
      this.lSecType.Name = "lSecType";
      this.lSecType.Size = new Size(58, 16);
      this.lSecType.TabIndex = 95;
      this.lSecType.Text = "SecType";
      this.lExchange.AutoSize = true;
      this.lExchange.BackColor = Color.Transparent;
      this.lExchange.Font = new Font("Arial", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 204);
      this.lExchange.ForeColor = Color.White;
      this.lExchange.Location = new Point(11, 633);
      this.lExchange.Name = "lExchange";
      this.lExchange.Size = new Size(66, 16);
      this.lExchange.TabIndex = 94;
      this.lExchange.Text = "Exchange";
      this.tbExchange.BackColor = Color.FromArgb(0, 22, 54);
      this.tbExchange.BorderStyle = BorderStyle.None;
      this.tbExchange.ForeColor = Color.White;
      this.tbExchange.Location = new Point(106, 633);
      this.tbExchange.Name = "tbExchange";
      this.tbExchange.Size = new Size(110, 13);
      this.tbExchange.TabIndex = 93;
      this.tbExchange.Text = "IDEALPRO";
      ...
      this.scrollPanel.Location = new Point(302, 136);
      this.scrollPanel.Name = "scrollPanel";
      this.scrollPanel.Size = new Size(25, 397);
      this.scrollPanel.TabIndex = 92;
      ...
      this.bSubmit.Location = new Point(222, 594);
      this.bSubmit.Name = "bSubmit";
      this.bSubmit.Size = new Size(101, 28);
      this.bSubmit.TabIndex = 66;
      ...
      this.tbName.BackColor = Color.FromArgb(0, 22, 54);
      this.tbName.BorderStyle = BorderStyle.None;
      this.tbName.ForeColor = Color.White;
      this.tbName.Location = new Point(106, 614);
      this.tbName.Name = "tbName";
      this.tbName.Size = new Size(110, 13);
      this.tbName.TabIndex = 65;
      this.tbName.Text = "GBP";
      ...
      this.lName.BackColor = Color.Transparent;
      this.lName.Font = new Font("Arial", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 204);
      this.lName.ForeColor = Color.White;
      this.lName.Location = new Point(11, 611);
      this.lName.Name = "lName";
      this.lName.Size = new Size(60, 16);
      this.lName.TabIndex = 64;
      this.lName.Text = "Currency";
      ...
      this.tbInstrumentId.Location = new Point(106, 593);
      this.tbInstrumentId.Name = "tbInstrumentId";
      this.tbInstrumentId.Size = new Size(110, 13);
      this.tbInstrumentId.TabIndex = 63;
      this.tbInstrumentId.Text = "EUR";
      this.tbInstrumentId.KeyDown += new KeyEventHandler(this.tbInstrumentId_KeyDown);
      this.tbInstrumentId.KeyPress += new KeyPressEventHandler(this.tbInstrumentId_KeyPress);
      ...
      this.lInstumentId.Location = new Point(11, 590);
      this.lInstumentId.Name = "lInstumentId";
      this.lInstumentId.Size = new Size(52, 16);
      this.lInstumentId.TabIndex = 62;
      this.lInstumentId.Text = "Symbol";
      ...
      this.label3.Size = new Size(125, 16);
      this.label3.TabIndex = 12;
      this.label3.Text = "IB TWS Instruments";
      ...
      this.Name = nameof (TWSInstrumetns);
      this.Text = "IB TWS Instruments";
