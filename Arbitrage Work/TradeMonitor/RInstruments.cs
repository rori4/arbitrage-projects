...
// Type: TradeMonitor.RInstruments
...
{
  public class RInstruments : Form
  {
    ...
    public RInstruments()
    {
      ...
      {
        int num = 1;
        foreach (SettingsProvider.Settings.rithmicSubscription rithmicSubscription in SettingsProvider.Settings.LocalSetting.rithmicSubscriptions)
        {
          ...
          row.Cells[nameof (InstrumentId)].Value = (object) rithmicSubscription.InstumentId.ToString();
          row.Cells[nameof (InstrumentName)].Value = (object) rithmicSubscription.symbol;
          row.Cells[nameof (Active)].Value = (object) rithmicSubscription.Enabled;
        }
      }
    ...
    private void button8_Click(object sender, EventArgs e)
    {
      ...
      if (!MainWindow.processes.ContainsKey("Rithmic"))
        return;
    ...
    private void bSubmit_Click(object sender, EventArgs e)
    {
      ...
      Error1.showError(SettingsProvider.Settings.LocalSetting.addNewInstrument(this.tbInstrumentId.Text, this.tbName.Text, this.tbExchange.Text, 3, ""));
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (RInstruments));
      ...
      this.label4.Size = new Size(284, 39);
      this.label4.TabIndex = 83;
      this.label4.Text = "For add new instrument in list, enter Instrument ID and \r\nExchange. Next Click \"Send\". For Example: Instrument Id: \r\n6EH6, Exchange: CME";
      ...
      this.Exchange.Size = new Size(66, 16);
      ...
      this.tbExchange.Location = new Point(104, 614);
      this.tbExchange.Name = "tbExchange";
      this.tbExchange.Size = new Size(110, 13);
      this.tbExchange.TabIndex = 66;
      this.tbExchange.Text = "CME";
      ...
      this.label3.Size = new Size(124, 16);
      this.label3.TabIndex = 12;
      this.label3.Text = "Rithmic Instruments";
      ...
      this.Name = nameof (RInstruments);
      this.Text = "Rithmic Instruments";
