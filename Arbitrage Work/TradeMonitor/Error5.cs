...
namespace TradeMonitor
{
  public class Error5 : Form
  {
    ...
    {
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (Error5));
      ...
      this.label1.Location = new Point(89, 115);
      this.label1.Name = "label1";
      this.label1.Size = new Size(177, 19);
      this.label1.TabIndex = 18;
      this.label1.Text = "User is already exists";
      this.label2.AutoSize = true;
      this.label2.BackColor = Color.Transparent;
      this.label2.Font = new Font("Arial", 9.75f);
      this.label2.ForeColor = Color.FromArgb(186, 11, 11);
      this.label2.Location = new Point(35, 5);
      ...
      this.Name = nameof (Error5);
      this.StartPosition = FormStartPosition.CenterScreen;
      this.Text = "User is already exists";
